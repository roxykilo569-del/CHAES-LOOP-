...
namespace VolFx
{
    [AddComponentMenu("VolFx/Transitions/VolFxTrans_Move_Out")]
    public class VolFxTrans_Move_Out : MonoBehaviour
    {
        ...
        {
            VolFxTrans_Move.s_Release.Add(this);
        }

        private void OnDisable()
        {
            VolFxTrans_Move.s_Release.Remove(this);
        }
    }
}