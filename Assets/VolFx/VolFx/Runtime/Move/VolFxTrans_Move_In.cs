...
namespace VolFx
{
    [AddComponentMenu("VolFx/Transitions/VolFxTrans_Move_In")]
    public class VolFxTrans_Move_In : MonoBehaviour
    {
        ...
        {
            VolFxTrans_Move.s_locks.Add(this);
        }

        private void OnDisable()
        {
            VolFxTrans_Move.s_locks.Remove(this);
        }
    }
}