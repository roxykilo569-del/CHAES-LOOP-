...
namespace VolFx
{
    ...
    public class GlitchPass : VolFx.Pass
    {
		...
		public Sides _sides = Sides.Clamp;
        ...
        private int              _warmup;
		private Sides			_sidesPrev = Sides.Unknown;
        ...
        {
			//var isSelective = _owner._source._source != VolFx.SourceOptions.Source.Camera;
			...
			void _updateClamp()
			{
				if (_sidesPrev != _sides)
				{
					switch (_sides)
					{
						case Sides.Clamp:
							mat.DisableKeyword("SIDES_REPEAT");
							mat.EnableKeyword("SIDES_CLAMP");
							break;
						case Sides.Repeat:
							mat.DisableKeyword("SIDES_CLAMP");
							mat.EnableKeyword("SIDES_REPEAT");
							break;
					}
